"""
Cilt Hastalığı Tespiti Modeli Eğitim Scripti
Cancer veri seti ile model eğitimi
"""
...
from src.disease_model import SkinDiseaseCNN
from src.data_loader import CancerDataset, get_cancer_transforms
...
def train_model(
    ...
    """Model eğitimi"""
    print("=" * 60)
    print("Cilt Hastalığı Tespiti Modeli Eğitimi")
    print("=" * 60)
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='Cilt Hastalığı Modeli Eğitimi')
    parser.add_argument('--csv', type=str, default=None, help='CSV dosya yolu')
    parser.add_argument('--images', type=str, default=None, help='Görüntü klasörü yolu')
    parser.add_argument('--epochs', type=int, default=20, help='Epoch sayısı')
